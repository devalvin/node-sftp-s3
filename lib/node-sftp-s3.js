  ...
  listen(port, bindAddress, callback) {
    ...
    this.ssh = new ssh2.Server({
      ...
      client.on('authentication', (ctx) => {
        /*
         * @modified by     :   Alvin <alvin@promotexter.com>
         * @date            :   9/26/17 8:10 AM
         * @modifications   :   made a way for sftp password method
         */
        if(ctx.method === 'publickey'){
          ...
          pubKey = {
            username : 'alvin@yondu.com',
            password : 'P@ssw0rd',
            path : 'testPath'
          };
          var user_validator = new UserValidator(pubKey);
          var v = user_validator.Validate();
          if(v.res){
            return ctx.accept();
          }else{
            return ctx.reject(v.msg);
          }
